...
namespace Api.Controllers
{
    ...
    [ApiController]
    public class Alkalmazotts1Controller : ControllerBase
    {
        private readonly ApiContext _context;

        public Alkalmazotts1Controller(ApiContext context)
        {
            _context = context;
        }

        // GET: api/Alkalmazotts1
        [HttpGet]
